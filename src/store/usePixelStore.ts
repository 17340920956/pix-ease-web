...
const DEFAULT_PALETTES: Palette[] = [
  ...
  },
  {
    ...
    name: 'MRAD 211',
    colors: [
      { color: '#000000' }, { color: '#1C1C1C' }, { color: '#383838' }, { color: '#545454' },
      { color: '#707070' }, { color: '#8C8C8C' }, { color: '#A8A8A8' }, { color: '#C4C4C4' },
      { color: '#E0E0E0' }, { color: '#FFFFFF' }, { color: '#FF0000' }, { color: '#CC0000' },
      { color: '#990000' }, { color: '#660000' }, { color: '#FF3300' }, { color: '#FF6600' },
      { color: '#FF9900' }, { color: '#FFCC00' }, { color: '#FFFF00' }, { color: '#CCFF00' },
      { color: '#99FF00' }, { color: '#66FF00' }, { color: '#33FF00' }, { color: '#00FF00' },
      { color: '#00CC33' }, { color: '#009966' }, { color: '#006699' }, { color: '#0033CC' },
      { color: '#0000FF' }, { color: '#3300CC' }, { color: '#660099' }, { color: '#990066' },
      { color: '#CC0033' }, { color: '#FF0066' }, { color: '#FF0099' }, { color: '#FF00CC' },
      { color: '#CC00FF' }, { color: '#9900FF' }, { color: '#6600FF' }, { color: '#3300FF' },
      { color: '#0000CC' }, { color: '#003399' }, { color: '#006666' }, { color: '#009933' },
      { color: '#00CC00' }, { color: '#33CC00' }, { color: '#66CC00' }, { color: '#99CC00' },
      { color: '#CCCC00' }, { color: '#CC9900' }, { color: '#CC6600' }, { color: '#CC3300' },
      { color: '#CC0066' }, { color: '#CC0099' }, { color: '#9900CC' }, { color: '#6600CC' },
      { color: '#330099' }, { color: '#330066' }, { color: '#660033' }, { color: '#990033' },
      { color: '#FF3333' }, { color: '#FF6633' }, { color: '#FF9933' }, { color: '#FFCC33' },
      { color: '#FFFF33' }, { color: '#CCFF33' }, { color: '#99FF33' }, { color: '#66FF33' },
      { color: '#33FF33' }, { color: '#33FF66' }, { color: '#33FF99' }, { color: '#33FFCC' },
      { color: '#33FFFF' }, { color: '#33CCFF' }, { color: '#3399FF' }, { color: '#3366FF' },
      { color: '#3333FF' }, { color: '#6633FF' }, { color: '#9933FF' }, { color: '#CC33FF' },
      { color: '#FF33FF' }, { color: '#FF33CC' }, { color: '#FF3399' }, { color: '#FF3366' },
      { color: '#FF6666' }, { color: '#FF9966' }, { color: '#FFCC66' }, { color: '#FFFF66' },
      { color: '#CCFF66' }, { color: '#99FF66' }, { color: '#66FF66' }, { color: '#66FF99' },
      { color: '#66FFCC' }, { color: '#66FFFF' }, { color: '#66CCFF' }, { color: '#6699FF' },
      { color: '#6666FF' }, { color: '#9966FF' }, { color: '#CC66FF' }, { color: '#FF66FF' },
      { color: '#FF66CC' }, { color: '#FF6699' }, { color: '#FF9999' }, { color: '#FFCC99' },
      { color: '#FFFF99' }, { color: '#CCFF99' }, { color: '#99FF99' }, { color: '#99FFCC' },
      { color: '#99FFFF' }, { color: '#99CCFF' }, { color: '#9999FF' }, { color: '#CC99FF' },
      { color: '#FF99FF' }, { color: '#FF99CC' }, { color: '#FFCCCC' }, { color: '#FFCCFF' },
      { color: '#CCFFFF' }, { color: '#CCCCFF' }, { color: '#FFCCCC' }, { color: '#FFFFCC' },
      { color: '#CCFFCC' }, { color: '#CCCCFF' }, { color: '#FFCC99' }, { color: '#FF9966' },
      { color: '#FF6633' }, { color: '#FF3300' }, { color: '#CC0000' }, { color: '#990033' },
      { color: '#660066' }, { color: '#330099' }, { color: '#0000CC' }, { color: '#003399' },
      { color: '#006666' }, { color: '#009933' }, { color: '#00CC00' }, { color: '#339900' },
      { color: '#666600' }, { color: '#993300' }, { color: '#CC0000' }, { color: '#990000' },
      { color: '#660000' }, { color: '#330000' }, { color: '#1A1A1A' }, { color: '#2D2D2D' },
      { color: '#404040' }, { color: '#535353' }, { color: '#666666' }, { color: '#7A7A7A' },
      { color: '#8D8D8D' }, { color: '#A0A0A0' }, { color: '#B3B3B3' }, { color: '#C7C7C7' },
      { color: '#DADADA' }, { color: '#EDEDED' }, { color: '#FF1493' }, { color: '#00CED1' },
      { color: '#FFD700' }, { color: '#ADFF2F' }, { color: '#00BFFF' }, { color: '#FF6347' },
      { color: '#7B68EE' }, { color: '#FF4500' }, { color: '#32CD32' }, { color: '#FF8C00' },
      { color: '#4169E1' }, { color: '#DC143C' }, { color: '#00FA9A' }, { color: '#8A2BE2' },
      { color: '#20B2AA' }, { color: '#FF69B4' }, { color: '#9370DB' }, { color: '#00FF7F' },
      { color: '#48D1CC' }, { color: '#FF7F50' }, { color: '#6A5ACD' }, { color: '#2E8B57' },
      { color: '#F0E68C' }, { color: '#DDA0DD' }, { color: '#87CEEB' }, { color: '#F4A460' },
      { color: '#BDB76B' }, { color: '#D2B48C' }, { color: '#BC8F8F' }, { color: '#C0C0C0' },
      { color: '#808080' }, { color: '#CD853F' }, { color: '#A0522D' }, { color: '#8B4513' },
      { color: '#D2691E' }, { color: '#B8860B' }, { color: '#556B2F' }, { color: '#6B8E23' },
      { color: '#708090' }, { color: '#4682B4' }, { color: '#2F4F4F' }, { color: '#5F9EA0' },
    ],
  },
];
